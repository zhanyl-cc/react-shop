        ...
        <div className="row">
          ...
          <div className="col-12 mt-5">
            <div className="contact-inner-wrapper d-flex justify-content-center ">
              <div>
                <h3 className="contact-title mb-4">Байланыш</h3>
                <form action="" className="d-flex flex-column gap-15">
                  ...
                  <div>
                    <textarea
                      ...
                      cols="30"
                      rows="4"
                      placeholder="Комментарийлер"
                    ></textarea>
                  </div>
                  <div>
                    <button className="button border-0">жөнөтүү</button>
                  </div>
                </form>
              </div>
              <div>
                <h3 className="contact-title mb-4">Биз менен байланышка чыгуу учун</h3>
                <div>
                  <ul className="ps-0">
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      <AiOutlineHome className="fs-5" />
                      <address className="mb-0">
                        Тыналиева 10а/Ахунбаева 
                      </address>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      <BiPhoneCall className="fs-5" />
                      <a href="tel:+996701454545">+996701454545</a>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
                    ...
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      ...
                      <p className="mb-0">Дүйшөмбү - Жума 10:00 - 20:00</p>
                    </li>
                  </ul>
                </div>
              </div>
