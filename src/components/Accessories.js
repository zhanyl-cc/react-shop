            ...
            <div className="xxl">
                <div className="row">
                    <div className="c0l-12">
                        {/* <div className="earphone position-relative">
                            <video className='vid ' src='images/video.mp4' />
                            <h2 className='position-absolute'>Кайсы AirPods сизге ылайыктуу?</h2>
                            <h4 className='position-absolute'>
                                Ар бир майда-чүйдөсүнө чейин жайлуу жана стилде уккула<br />
                                Сүйүктүү ырыңызды чуркоо тилкесин басып жатканда ойнотуңуз,<br /> басып баратып жумушка чалыңыз же ойноп жүргөндө бардык үндү өчүрүңүз.<br /> Ар бирине ылайыктуу наушник же гарнитура бар.</h4>
                        </div> */}
                                    ...
                                    <div className="col-3 ">
                                        <Link className="product-card position-relative">
                                            ...
                                            <div className="product-image">
                                                ...
                                                <img src='images/ipad2.avif' />
                                            </div>
                                            <div className="product-details mt-5">
                                                <h2>Apple Magic Bluetooth клавиатурасы iPad Pro 11 дюйм үчүн </h2>
                                                <h6 className="brand"> Apple
                                                </h6>
                                                <p> <b>Багыттоо түрү:</b>Планшет үчүн<br />
                                                    <b>Шайкеш OS:</b>  iPadOS 14.5 жана андан жогору<br />
                                                    <b>Туташуу:</b>Зымсыз, Bluetooth<br />
                                                    <b>Кайра заряддалуучу:</b> Ооба, Type C порту<br />
                                                    <b></b>Жылмакай бурчту жөнгө салуу, ыңгайлуу арткы жарык баскычтары, кайчы механизми<br />
                                                    <b>Кепилдик:</b>1 жылдык кепилдик
