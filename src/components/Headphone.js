                                    ...
                                    <div className="col-3 ">
                                        <Link className="product-card position-relative">
                                            ...
                                            <div className="product-image">
                                                <img src='images/airmax.avif' />
                                                <img src='images/airmax2.avif' />
                                            </div>
                                            <div className="product-details mt-5">
                                                <h2>Apple AirPods Max MGYH3HN/A</h2>
                                                ...
                                                <p> <b>Багыттоо түрү:</b>Ашыкча кулак <br />
                                                    ...
                                                    <b>Аудио технологиясы:</b>Adaptive EQ, Transparency Mode, Динамикалык башты көзөмөлдөө менен<br />
                                                    <b>Микрофон:</b> микрофону бар зымсыз гарнитура <br />
